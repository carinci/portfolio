...
export const Badge = twc.span`inline-flex select-none items-center gap-0.5 rounded border-2 border-black bg-black px-1.5 py-0.5 lowercase text-white transition-colors hover:bg-transparent hover:text-black`
